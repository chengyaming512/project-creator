...
public class SwaggerFileTemplate {
	...
	public static void main(String[] args) {
		System.out.println("# This is a sample Swagger spec, describing a simple API as a starting point.  ");
		System.out.println("swagger: \"2.0\"");
		System.out.println("info:");
		System.out.println("  description: Game entity for game business logic");
		...
		for(String path:args){
			...
			System.out.println("      description: Create object with full info.");
			...
			System.out.println("            $ref: '#/definitions/"+path
					+ "'");
			...
			System.out.println("      description: Query objects according given conditions.");
			...
			System.out.println("          description: the first record to be returned.");
			System.out.println("          in: query");
			System.out.println("          required: false");
			System.out.println("          type: integer");
			System.out.println("          format: int32");
			System.out.println("        - name: max");
			System.out.println("          description: the max number of records to be returned.");
			System.out.println("          in: query");
			System.out.println("          required: false");
			System.out.println("          type: integer");
			System.out.println("          format: int32");
			...
			System.out.println("          description: The requested game was not found");
			...
			System.out.println("      description: Get the object with its ID.");
			...
			System.out.println("      description: Update object with full info.");
			...
			System.out.println("      description: delete object with specified ID.");
